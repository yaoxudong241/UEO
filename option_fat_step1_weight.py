...
parser.add_argument('--model', default='fat_step1_weight',
                    help='model name')
parser.add_argument('--act', type=str, default='relu',
                    help='activation function')
parser.add_argument('--pre_train', type=str, default=r'D:\yxd\code\nips_uncertainy\experiment\X2\FAT_fat_s_x2_step1_weight\model\model_point1.pt',
                    help='pre-trained model directory')
parser.add_argument('--pre_train_step1', type=str, default=r'.',
...
# Log specifications
parser.add_argument('--save', type=str, default='../experiment/X2/FAT_fat_s_x2_step1_weight',
...
parser.add_argument('--testset', type=str, default='AID',
